...
public class JavaClass {
	...
	public String getSqlColumnsAsCSV() {
		...
		Enumeration enum3 = fields.elements();
		while (enum3.hasMoreElements()) {
			Field field = (Field) enum3.nextElement();
	...
	public String getQuotedSqlColumns() {
		StringBuffer buf = new StringBuffer();
		Enumeration enum4 = fields.elements();
		while (enum4.hasMoreElements()) {
			Field field = (Field) enum4.nextElement();
			buf.append("\"");
			buf.append(field.getColumn().getName());
			buf.append("\"");
			if (enum4.hasMoreElements())
				buf.append(",");
		}
		return buf.toString();
	}
	...
	public String getSqlPlaceHoldersAsCSV() {
		StringBuffer buf = new StringBuffer();
		Enumeration enum5 = fields.elements();
		while (enum5.hasMoreElements()) {
			Field field = (Field) enum5.nextElement();
			buf.append("?");
			if (enum5.hasMoreElements())
				buf.append(",");
		}
		return buf.toString();
	}
