...
public class VelocityTest 
{
  ...
  public static void main (String args[]) throws Exception {
    ...
    String xmlFile = "D:/project/xit/work/pojo/input/typebean.xml";
    ...
    VelocityTest test = new VelocityTest(url);
    test.run1();
    System.out.println("==================");
    test.run3();
  ...
  public void run3(){
    ...
    p.setProperty("file.resource.loader.path", "/d:/project/xit/templates/pojo");
